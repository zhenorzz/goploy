...
CREATE TABLE `project`  (
  ...
  `after_pull_script` text CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL DEFAULT '' COMMENT '脚本路径',
  `after_deploy_script` text CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL DEFAULT '' COMMENT '脚本路径',
...
CREATE TABLE `user`  (
  ...
  `manager_group_str` text CHARACTER SET ascii NOT NULL COMMENT '管理分组逗号分割(0没有管理权限，空串管理全部)',
