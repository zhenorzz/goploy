      ...
      >
        ...
        <template #reference>
          <div style="width: 100%; height: 100%">
            <div class="wg-cap-state__default" @click="handleBtnEvent">
              <!-- init -->
            ...
            <div class="wg-cap-state__check" @click="() => false">
              <!-- check -->
              <div class="wg-cap-state__inner">
            ...
            <div class="wg-cap-state__error" @click="handleBtnEvent">
              <!-- error -->
              <div class="wg-cap-state__inner">
                <div class="wg-cap-btn__ico">
                  <img
            ...
            <div class="wg-cap-state__over" @click="handleBtnEvent">
