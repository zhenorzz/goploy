<template>
  <ElRow>
    ...
    <el-table :data="tableData" style="width: 100%">
      ...
      <el-table-column prop="path" label="部署目录" show-overflow-tooltip />
    ...
    <el-dialog title="新增服务器" :visible.sync="dialogFormVisible">
      <el-form ref="form" :rules="form.rules" :model="form">
        ...
        <el-form-item label="部署目录" label-width="120px" prop="path">
          <el-input v-model="form.path" autocomplete="off" placeholder="绝对路径" />
        </el-form-item>
        <el-form-item label="sshKey所有者" label-width="120px" prop="owner">
          <el-input v-model="form.owner" autocomplete="off" placeholder="root" />
        </el-form-item>
      </el-form>
